...
class Corpus(object):
    def __init__(self, path, batch_size, max_sql):
        ...
        # Choose the dataset for test
        self.valid = self.tokenize(os.path.join(path, 'valid.txt'))
        # self.valid = self.tokenize(os.path.join(path, 'WikiText103_valid.txt'))
        # self.valid = self.tokenize(os.path.join(path, 'WikiText103_test.txt'))
        # self.valid = self.tokenize(os.path.join(path, 'WikiText2_valid.txt'))
        # self.valid = self.tokenize(os.path.join(path, 'WikiText2_test.txt'))
        # self.valid = self.tokenize(os.path.join(path, 'TinyShakespeare.txt'))
